...
from .eva_x_encoder import EvaXVisionTower
from .eva_clip_encoder import EvaClipVisionTower

# from .dev_eva_clip.eva_x import EvaXWrapper
...
def build_vision_tower(vision_tower_cfg, **kwargs):
    ...
    elif vision_tower.startswith("eva-x"):
        return EvaXVisionTower(vision_tower, args=vision_tower_cfg, **kwargs)
    elif vision_tower.startswith("EVA02-CLIP"):
