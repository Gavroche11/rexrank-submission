...
class LLaVATrainer(Trainer):
    ...
    def _save_checkpoint(self, model, trial, metrics=None):
        ...
        elif hasattr(self.args, "mm_tunable_parts") and (len(self.args.mm_tunable_parts.split(",")) == 2 and "mm_mlp_adapter" in self.args.mm_tunable_parts and "mm_language_model" in self.args.mm_tunable_parts):
            # Save Adapter and Language Model (non-lora)
