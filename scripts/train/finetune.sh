...
deepspeed --master_port 12345 --include localhost:${DEVICES} llava/train/train_mem.py \
    ...
    --data_path /home/BARO_Cluster/data/data/llava_input/${PRETRAIN_NAME}/mimic+chexpert-train.json \
    --eval_data_path /home/BARO_Cluster/data/data/llava_input/${PRETRAIN_NAME}/mimic+chexpert-val.json \
