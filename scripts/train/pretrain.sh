...
VISION_MODEL_PRETRAINED_WEIGHT="/home/data1/workspace/bih1122/model_weights/vis-encoder-cls/vis-v2.4/2024-12-17-01-25-46/best.pth"
...
deepspeed --include localhost:${DEVICES} --master_port 12345 llava/train/train_mem.py \
    ...
    --data_path /home/BARO_Cluster/data/data/llava_input/${BASE_RUN_NAME}/mimic+chexpert-train.json \
    --eval_data_path /home/BARO_Cluster/data/data/llava_input/${BASE_RUN_NAME}/mimic-val.json \
